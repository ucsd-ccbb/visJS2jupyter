...
def save_to_html(graph_html_object,outputpath,graph_id=0,style_file=None):
    """
    Function to save the graph object to standalone HTML file.
    Inputs:
        graph_html_object:  HTML object generated by visjs_network call.
        outputpath:         Output path to HTML file.
    Returns:
        None
    """
    html = graph_html_object.data
    ...
    if style_file is None:
        ...
        fname_temp = style_file
    output_style_file = os.path.join(os.path.dirname(os.path.abspath(outputpath)),fname_temp)
    if not os.path.isfile(output_style_file):
        copyfile(fname_temp,output_style_file)
...
def visjs_network(nodes_dict, edges_dict,
                           ...
                           style_file = None,            # Allow setting the style_file path. If it exists, it will be used as is.
